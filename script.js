        ...
        return [
            ...
            },
            {
            ...
            },
             {
                ...
                icon: "-",
                color: "purple",
                description: "Layar pecah, HP mati total, baterai boros, atau error software? Serahkan pada AstaCloud. Teknisi ahli, pengerjaan rapi, harga bersahabat, dan bergaransi."
            },
...
loadServices: function() {
    ...
    services.forEach((service, index) => {
        ...
        // Set background image based on service ID
        let backgroundImage = '';
        if (service.id === 1) {
            backgroundImage = "url('https://image2url.com/r2/default/images/1769765075102-c628cfa6-be97-4c16-9979-096f82882883.jpg')";
        } else if (service.id === 2) {
            backgroundImage = "url('https://image2url.com/r2/default/images/1769765458783-92d7cff8-ad1c-4b97-b365-bd5a7860acb3.jpg')";
        } else if (service.id === 3) {
            backgroundImage = "url('https://image2url.com/r2/default/images/1769765707384-639f04b4-922e-4467-8427-35b75911d7c3.jpg')";
        } else if (service.id === 4) {
            backgroundImage = "url('https://image2url.com/r2/default/images/1769766077342-3f05c5ee-e8d5-46a5-b64e-af5cc5014d95.blob')";
        } else if (service.id === 5) {
            backgroundImage = "url('https://image2url.com/r2/default/images/1769775324380-f3025bc3-df75-41e1-8a50-382ed3978733.png')";
        }
        ...
        serviceCard.innerHTML = `
            <div class="h-48 relative" style="background-image: ${backgroundImage}; background-size: cover; background-position: center;">
...
loadDomains: function() {
    ...
    domains.forEach((domain, index) => {
        ...
        // Set background image based on domain ID
        let backgroundImage = '';
        if (domain.id === 1) {
            backgroundImage = "url('https://image2url.com/r2/default/images/1769766481835-f98582a2-f104-4b58-868a-022b8313e4ed.jpg')";
        } else if (domain.id === 2) {
            backgroundImage = "url('https://image2url.com/r2/default/images/1769775498406-a9cc174b-a105-492d-a178-689c75f9cc80.png')";
        } else if (domain.id === 3) {
            backgroundImage = "url('https://image2url.com/r2/default/images/1769775536618-639572bf-841a-4a4d-ae2b-85642f4a8245.png')";
        } else if (domain.id === 4) {
            backgroundImage = "url('https://image2url.com/r2/default/images/1769775568635-97f393fc-bd70-4888-bb10-aa82387ccb5a.png')";
        } else if (domain.id === 5) {
            backgroundImage = "url('https://image2url.com/r2/default/images/1769776014707-a6679755-8c07-4296-857c-547b03394365.png')";
        } else if (domain.id === 6) {
            backgroundImage = "url('https://image2url.com/r2/default/images/1769776160341-8542803d-be67-429c-baeb-47da74d4d29c.png')";
        } else if (domain.id === 7) {
            backgroundImage = "url('https://image2url.com/r2/default/images/1769776325153-fb1f2dc2-7838-43d7-a421-5a5ceab0c768.png')";
        } else if (domain.id === 8) {
            backgroundImage = "url('https://image2url.com/r2/default/images/1769776404862-abf0f906-17e5-46a9-b364-944b9a6dd30d.png')";
        }
        ...
        if (domain.discount > 0) {
            ...
            priceHTML = `
                <div class="price-container">
                    <span class="text-white font-bold text-lg">${domain.price}/tahun</span>
                </div>
            `;
        }
            ...
            <div class="testimonial-card" data-aos="fade-up">
                <div class="flex items-center mb-4">
                    ...
                    <div>
                        ...
                        ${testimonial.company ? `<p class="text-sm">${testimonial.company}</p>` : ''}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.addEventListener('scroll', function() {
        ...
        if (currentScroll > 100) {
            ...
            if (isDarkTheme) {
                navbar.style.backgroundColor = 'rgba(30, 30, 30, 0.9)';
            } else {
